    ...
    <div class="footer py-5 text-light" style="background-color: black" data-aos="flip-up" data-aos-duration="2000">
        <div class="card" style="background-color: black">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                            <h4 class="mt-3" style="color: rgb(175, 146,
                                73);">
                                <strong>B'PRIMERA STUDIO</strong>
                            </h4>
                            <hr>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                            <h4 class="mt-3"><strong>Services</strong></h4>
                            <hr>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                            <h4 class="mt-3"><strong>Links</strong></h4>
                            <hr>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                            <h4 class="mt-3"><strong>Contacts</strong></h4>
                            <hr>
            ...
            <div class="socials d-flex mt-4 me-auto ms-auto">
                <a href="" class="me-3 ms-3" target="_blank">
