            ...
            <div class="container">
                <div class="card ">
                    <div class="card-header">
                        ...
                        <span class="float-end"><a href="{{ route('admin.add-photo') }}"><button
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <input type="text" style="width: 300px" placeholder="Search..." wire:model="search"
                            class="form-control">
                                ...
                                @if (count($photos) > 0)
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($photos as $photo)
                                            <tr>
                                                {{-- <td>{{$photo->id}}</td> --}}
                                                <td><img src="{{ asset('storage/cover-photos/' . $photo->main_image) }}"
                                                        alt="" width="50px"></td>
                                                <td>{{ $photo->title }}</td>
                                                ...
                                                <td>
                                                    <a href="{{ route('admin.view-photo', $photo->slug) }}"><i
                                                            class="fa fa-eye fa-2x"></i></a>
                                                </td>

                                                <td>
                                                    <a href="{{ route('admin.edit-photo', $photo->slug) }}"><i
